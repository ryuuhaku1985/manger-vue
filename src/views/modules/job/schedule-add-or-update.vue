  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      ...
      <el-form-item label="任务类型" prop="jobType">
        <el-input v-model="dataForm.jobType" placeholder="0：多次，1：仅一次"></el-input>
      </el-form-item>
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === '0') {
                this.dataForm.beanName = data.resp.schedule.beanName
                this.dataForm.methodName = data.resp.schedule.methodName
                this.dataForm.params = data.resp.schedule.params
                this.dataForm.cronExpression = data.resp.schedule.cronExpression
                this.dataForm.jobType = data.resp.schedule.jobType
                this.dataForm.remark = data.resp.schedule.remark
                this.dataForm.status = data.resp.schedule.status
              }
            })
          }
        })
