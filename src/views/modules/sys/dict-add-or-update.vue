        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === '0') {
                this.dataForm.name = data.resp.dict.name
                this.dataForm.type = data.resp.dict.type
                this.dataForm.code = data.resp.dict.code
                this.dataForm.value = data.resp.dict.value
                this.dataForm.orderNum = data.resp.dict.orderNum
                this.dataForm.remark = data.resp.dict.remark
                this.dataForm.delFlag = data.resp.dict.delFlag
              }
            })
          }
        })
