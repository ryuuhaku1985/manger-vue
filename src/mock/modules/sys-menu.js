...
var dataList = [
  ...
  },
  {
    ...
    'parentName': '系统管理',
    'name': 'SQL监控',
    'url': 'https://mg.flashpesa.co.ke/admin/druid/sql.html',
    'perms': null,
    'type': 1,
    'icon': 'sql',
    'orderNum': 4,
  ...
  },
  {
    ...
    'name': '新增',
    'url': null,
    'perms': 'sys:dept:save,sys:dept:list',
    'type': 2,
    'icon': null,
    'orderNum': 0,
    'open': null,
  ...
  },
  {
    ...
    'name': '修改',
    'url': null,
    'perms': 'sys:dept:update,sys:dept:list',
    'type': 2,
    'icon': null,
    'orderNum': 0,
    'open': null,
...
export function select () {
  ...
  dataList = dataList.concat(dataList[1].list)
  return {
    isOpen: true,
    url: '/sys/menu/select',
    type: 'get',
